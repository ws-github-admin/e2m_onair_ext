...
function get_sponsors_meeting(req, res) {
    let params = {
        POST: {
            methodToCall: user.getSponsorsMeeting,
            methodNameText: "user.getSponsorsMeeting",
            allowedRoles: [],
            isPrivate: true,
        },
    };
...
function scanned_dashboard_analysis(req, res) {
    let params = {
        POST: {
            methodToCall: user.scannedDashboardAnalysis,
            methodNameText: "user.scannedDashboardAnalysis",
            allowedRoles: [],
            isPrivate: false,
        },
    };
