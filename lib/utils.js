...
//     config.CALENDAR_AUTH2.CLIENT_ID,
//     config.CALENDAR_AUTH2.CLIENT_SECRET,
//     config.CALENDAR_AUTH2.REDIRECT_URI
// );
...
async function createICS(payload) {
    return new Promise(async (resolve, reject) => {
        let attachment = null;
        const { start, duration, title, description, event_location, geo_location, status, organizer, event_url, attendees, alarms, calName } = payload;
        ...
        const event = {
            ...
            status: status,
            organizer: organizer,
            method: 'REQUEST', // Ensures invite request
            attendees: attendees,
            // attendees: [
            //     {
            //         name: 'Debashis Giri',
            ...
            // attendees: [
            //     {
            //         name: 'Sourav Bhattacherjee',
            //         email: 'sourav.bhattacherjee@webspiders.com',
            //         rsvp: true,
            //         partstat: 'NEEDS-ACTION',
            //         role: 'REQ-PARTICIPANT'
            //     }
...
// async function authenticateCalendarAPI(payload) {
//     return new Promise(async (resolve, reject) => {
...
//         });
//     } else {
//         const authCode = await authenticateCalendarAPI();
//         const { tokens } = await oAuth2Client.getToken(authCode);
//         oAuth2Client.setCredentials(tokens);
//         console.log('Store these tokens in your .env file:');
...
// async function createEventAuth(auth) {
//     console.log("createEventAuth");
...
//         start: {
//             dateTime: '2025-04-29:00:00-07:00', // ISO string
//             timeZone: 'America/Los_Angeles',
//         },
//         end: {
//             dateTime: '2025-04-29:00:00-07:00',
//             timeZone: 'America/Los_Angeles',
//         },
//         attendees: [
//             { email: 'debashis.giri@webspiders.com' },
//             { email: 'giri.debashis@gmail.com' },
//         ],
//         reminders: {
//             useDefault: true,
//         },
//     };
//     console.log("createEventAuth event: ", event)
//     try {
//         const response = await calendar.events.insert({
//             calendarId: 'primary', // Or a specific calendar ID
//             resource: event,
//             sendUpdates: 'all', // This sends the invite email to attendees
//         });
//     } catch (err) {
