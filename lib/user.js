                ...
                if (meetings.length > 0) {
                    ...
                    meetings.forEach((meeting, index) => {
                        ...
                        if(requestor.Designation.length > 30) {
                            designation = requestor.Designation.substring(0, 30) + '...';
                        }else{
                        ...
                        doc.fontSize(10)  // Reduced from 10 to 8
                            .text(`Designation: ${designation || 'N/A'}`, startX + 10, startY + 55);
                        ...
                        // Smaller font for Designation
                        doc.fontSize(10)  // Reduced from 10 to 8
                            .text(`Designation: ${designation || 'N/A'}`, inviteeX + 10, startY + 55);
